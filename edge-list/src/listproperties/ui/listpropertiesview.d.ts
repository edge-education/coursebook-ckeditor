...
export default class ListPropertiesView extends View {
     ...
     * @readonly
     */
    bracketedSwitchButtonView: SwitchButtonView | null;
    /**
     ...
     */
    private _createBracketedSwitchButton;
}
...
/**
 * Fired when the list order has changed (bracketed) via {@link ~ListPropertiesView#reversedSwitchButtonView}.
 *
 * @eventName ~ListPropertiesView#listBracketed
 */
export type ListPropertiesViewListBracketedEvent = {
    name: 'listBracketed';
    args: [];
};
