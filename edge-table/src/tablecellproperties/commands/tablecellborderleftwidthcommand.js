...
/**
 * The table cell left border width command.
 *
 * The command is registered by the {@link module:table/tablecellproperties/tablecellpropertiesediting~TableCellPropertiesEditing} as
 * the `'tableCellBorderLeftWidth'` editor command.
 *
 * To change the border width of selected cells, execute the command:
 *
 * ```ts
 * editor.execute( 'tableCellBorderLeftWidth', {
 *   value: '5px'
 * } );
 * ```
 *
 ...
 */
export default class TableCellBorderLeftWidthCommand extends TableCellPropertyCommand {
    /**
    ...
    constructor(editor, defaultValue) {
        super(editor, 'tableCellBorderLeftWidth', defaultValue);
    }
