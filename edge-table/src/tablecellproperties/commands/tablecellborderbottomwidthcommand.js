...
/**
 * The table cell bottom border width command.
 *
 * The command is registered by the {@link module:table/tablecellproperties/tablecellpropertiesediting~TableCellPropertiesEditing} as
 * the `'tableCellBorderBottomWidth'` editor command.
 *
 * To change the border width of selected cells, execute the command:
 *
 * ```ts
 * editor.execute( 'tableCellBorderBottomWidth', {
 *   value: '5px'
 * } );
 * ```
 *
 ...
 */
export default class TableCellBorderBottomWidthCommand extends TableCellPropertyCommand {
    /**
    ...
    constructor(editor, defaultValue) {
        super(editor, 'tableCellBorderBottomWidth', defaultValue);
    }
