...
/**
 * The table cell top border width command.
 *
 * The command is registered by the {@link module:table/tablecellproperties/tablecellpropertiesediting~TableCellPropertiesEditing} as
 * the `'tableCellBorderTopWidth'` editor command.
 *
 * To change the border width of selected cells, execute the command:
 *
 * ```ts
 * editor.execute( 'tableCellBorderTopWidth', {
 *   value: '5px'
 * } );
 * ```
 *
 ...
 */
export default class TableCellBorderTopWidthCommand extends TableCellPropertyCommand {
    /**
    ...
    constructor(editor, defaultValue) {
        super(editor, 'tableCellBorderTopWidth', defaultValue);
    }
