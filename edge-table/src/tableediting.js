...
export default class TableEditing extends Plugin {
    ...
    init() {
        ...
        editor.commands.add('insertTableTemplate', new InsertTableTemplateCommand(editor));
